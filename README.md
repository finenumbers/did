...
- Separate «Номера Twilio» section (`/twilio`): sample of available E.164 numbers (not a full inventory); «Синхронизация» loads countries/prices/sample, then enriches a row or the full list with `%00%`–`%99%`
