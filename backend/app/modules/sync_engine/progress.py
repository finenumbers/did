...
STAGE_DEFS: list[dict[str, str]] = [
    {"id": "prepare", "group": "Подготовка", "label": "Подготовка"},
    ...
    {"id": "finalize", "group": "Завершение", "label": "Завершение"},
...
_PHASE_STAGE: dict[tuple[str, str], str] = {
    ...
    ("uis", "dictionaries"): "uis_dictionaries",
    ("uis", "free"): "uis_free",
    ("uis", "purchased"): "uis_purchased",
    ("aurora", "dictionaries"): "aurora_dictionaries",
    ("aurora", "free"): "aurora_free",
    ("aurora", "purchased"): "aurora_purchased",
    ("exolve", "dictionaries"): "exolve_dictionaries",
    ("exolve", "free"): "exolve_free",
    ("exolve", "purchased"): "exolve_purchased",
    ("voximplant", "dictionaries"): "voximplant_dictionaries",
    ("voximplant", "free"): "voximplant_free",
    ("voximplant", "purchased"): "voximplant_purchased",
    ("mcn", "dictionaries"): "mcn_dictionaries",
    ("mcn", "free"): "mcn_free",
    ("mcn", "purchased"): "mcn_purchased",
    ("finenumbers", "dictionaries"): "finenumbers_dictionaries",
